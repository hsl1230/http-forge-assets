...
// Initialize and increment total requests counter
let totalRequests = parseInt(pm.collectionVariables.get('total_requests') || 0);
totalRequests++;
pm.collectionVariables.set('total_requests', totalRequests);
